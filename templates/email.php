...
$config = array();
$config['siteadminemail']     = '{{siteadminemail}}'; // The default email address of the site administrator
$config['siteadminbounce']    = '{{siteadminbounce}}'; // The default email address used for error notification of sent messages for the site administrator (Return-Path)
$config['siteadminname']      = '{{siteadminname}}'; // The name of the site administrator
